...
export const STRINGS: Dict = {
  ...
  'wl.lede':         { en: 'Fired, shorted on pay, or pushed out — then left digging through old texts and pay stubs, wondering if anyone will believe you? one3seven turns that pile into one clear, dated record, so when you sit down with a lawyer, nothing that matters gets missed. Free, private, and yours to keep.',
                       es: '¿Te despidieron, te pagaron de menos o te forzaron a renunciar — y ahora buscas entre mensajes viejos y recibos de pago, sin saber si alguien te va a creer? one3seven convierte ese montón en un expediente claro y fechado, para que cuando te sientes con un abogado, no se pierda nada que importe. Gratis, privado y tuyo para siempre.' },
