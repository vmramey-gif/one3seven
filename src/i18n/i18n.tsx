...
export const STRINGS: Dict = {
  ...
  'wl.hero.card.before': { en: 'What you have',                 es: 'Lo que tienes' },
  'wl.hero.card.arrow':  { en: 'Organized by date',             es: 'Ordenado por fecha' },
  'wl.hero.card.after':  { en: 'What you get',                  es: 'Lo que recibes' },
  'wl.hero.card.foot':   { en: 'Every item links back to your original document.',
                           es: 'Cada elemento enlaza a tu documento original.' },
  ...
  'wl.hero.r1d':     { en: 'Mar 3',                             es: '3 mar' },
  'wl.hero.r1t':     { en: 'Pay stub',                          es: 'Recibo de pago' },
  'wl.hero.r2d':     { en: 'Apr 12',                            es: '12 abr' },
  'wl.hero.r2t':     { en: 'Text message',                      es: 'Mensaje de texto' },
  'wl.hero.r3d':     { en: 'May 2',                             es: '2 may' },
  'wl.hero.r3t':     { en: 'Letter from HR',                    es: 'Carta de RR. HH.' },
