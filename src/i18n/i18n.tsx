...
export const STRINGS: Dict = {
  ...
  'wl.h1b':          { en: 'Walk in with the receipts.',          es: 'Llega con las pruebas.' },
  ...
  'wl.straight.body':{ en: 'An attorney decides that — that’s their job, not a tool’s. What one3seven does is make sure that when you walk into that conversation, you’re prepared, your story is intact, and nothing important got lost — so your attorney can spend the first meeting reviewing your records, not reconstructing them.',
                       es: 'Eso lo decide un abogado — es su trabajo, no el de una herramienta. Lo que one3seven hace es asegurarse de que, cuando entres a esa conversación, estés preparado, tu historia esté intacta y no se haya perdido nada importante — para que tu abogado dedique la primera reunión a revisar tus documentos, no a reconstruirlos.' },
