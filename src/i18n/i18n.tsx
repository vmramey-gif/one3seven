...
export const STRINGS: Dict = {
  ...
  'nav.workers':     { en: 'Trouble at work?',                   es: '¿Problemas en el trabajo?' },
  ...
  // ── Shared marketing nav / CTA labels ──
  ...
  'wl.h1a':          { en: 'Trouble at work?',                   es: '¿Problemas en el trabajo?' },
  'wl.h1b':          { en: 'Keep the receipts.',                  es: 'Guarda las pruebas.' },
  'wl.belief':       { en: "Don't be scattered anymore — let us help.", es: 'Ya no más desorden — déjanos ayudarte.' },
  'wl.lede':         { en: 'Fired, shorted on pay, or pushed out — then left digging through old texts and pay stubs, wondering if anyone will believe you? one3seven turns that pile into one clear, dated record, so you can walk into that conversation with everything organized in one place. Free, private, and yours to keep.',
                       es: '¿Te despidieron, te pagaron de menos o te forzaron a renunciar — y ahora buscas entre mensajes viejos y recibos de pago, sin saber si alguien te va a creer? one3seven convierte ese montón en un expediente claro y fechado, para que puedas llegar a esa conversación con todo organizado en un solo lugar. Gratis, privado y tuyo para siempre.' },
  ...
  'wl.own.eyebrow':  { en: 'Yours, start to finish',             es: 'Tuyo, de principio a fin' },
  'wl.own.h':        { en: 'One place for your whole story — and it never stops being yours.',
                       es: 'Un solo lugar para toda tu historia — y siempre será tuya.' },
  'wl.own.body':     { en: 'From the first thing that went wrong through the whole case, your record stays in one place — organized and up to date. Download it anytime. Take it to any attorney you choose. No one can lock it away from you.',
                       es: 'Desde lo primero que salió mal y durante todo el caso, tu expediente se queda en un solo lugar — organizado y al día. Descárgalo cuando quieras. Llévalo al abogado que tú elijas. Nadie puede quitártelo.' },
  'wl.own.s1':       { en: 'You tell it',                         es: 'Tú la cuentas' },
  'wl.own.s2':       { en: 'You own it',                          es: 'Es tuya' },
  'wl.own.s3':       { en: 'You choose who sees it',              es: 'Tú eliges quién la ve' },
  // Mitigation (job-search) log card
  'ml.eyebrow':      { en: 'Your job-search record',              es: 'Tu registro de búsqueda de empleo' },
  'ml.title':        { en: 'Looking for work? Keep a note of it here.', es: '¿Buscando trabajo? Anótalo aquí.' },
  'ml.desc':         { en: 'Jot down where you applied and what happened. It becomes part of your record — and, like everything here, it stays yours.',
                       es: 'Anota dónde solicitaste y qué pasó. Se vuelve parte de tu expediente — y, como todo aquí, es tuyo.' },
  'ml.add':          { en: 'Add',                                 es: 'Agregar' },
  'ml.date':         { en: 'Date you applied',                    es: 'Fecha en que solicitaste' },
  'ml.happened':     { en: 'What happened',                       es: 'Qué pasó' },
  'ml.employer':     { en: 'Employer / company',                  es: 'Empleador / empresa' },
  'ml.employer.ph':  { en: 'e.g. Acme Foods',                     es: 'p. ej. Acme Foods' },
  'ml.role':         { en: 'Role / position',                     es: 'Puesto / posición' },
  'ml.role.ph':      { en: 'e.g. Warehouse associate',            es: 'p. ej. Asociado de almacén' },
  'ml.notes':        { en: 'Notes (optional)',                    es: 'Notas (opcional)' },
  'ml.notes.ph':     { en: 'Anything you want to remember about it', es: 'Algo que quieras recordar' },
  'ml.save':         { en: 'Save to my record',                   es: 'Guardar en mi expediente' },
  'ml.cancel':       { en: 'Cancel',                              es: 'Cancelar' },
  'ml.loading':      { en: 'Loading your record…',                es: 'Cargando tu registro…' },
  'ml.empty':        { en: 'Nothing logged yet. Add the first place you applied whenever you’re ready — there’s no wrong time to start.',
                       es: 'Aún no hay nada. Agrega el primer lugar donde solicitaste cuando quieras — nunca es mal momento para empezar.' },
  'ml.remove':       { en: 'Remove entry',                        es: 'Eliminar entrada' },
  'ml.disclaimer':   { en: 'This is your own record. one3seven never scores it or decides whether it’s “enough” — that’s a question for you and your attorney.',
                       es: 'Este es tu propio registro. one3seven nunca lo califica ni decide si es “suficiente” — esa es una pregunta para ti y tu abogado.' },
  'ml.saving':       { en: 'Saving…',                             es: 'Guardando…' },
  'ml.outcome.applied':     { en: 'Applied',      es: 'Solicitado' },
  'ml.outcome.interview':   { en: 'Interview',    es: 'Entrevista' },
  'ml.outcome.offer':       { en: 'Offer',        es: 'Oferta' },
  'ml.outcome.hired':       { en: 'Hired',        es: 'Me contrataron' },
  'ml.outcome.declined':    { en: 'Declined',     es: 'Rechazada' },
  'ml.outcome.no_response': { en: 'No response',  es: 'Sin respuesta' },
  // Reminders card (worker-owned "what's mine to do"; logistics only, never a computed deadline)
  'rem.eyebrow':     { en: 'What’s mine to do',                  es: 'Lo que me toca hacer' },
  'rem.title':       { en: 'Your reminders.',                    es: 'Tus recordatorios.' },
  'rem.desc':        { en: 'Keep track of what’s next — records to upload, an appointment, a form to send back. Add your own, or tap a suggestion.',
                       es: 'Lleva el control de lo que sigue — registros por subir, una cita, un formulario por devolver. Agrega los tuyos o toca una sugerencia.' },
  'rem.add':         { en: 'Add reminder',                       es: 'Agregar recordatorio' },
  'rem.what':        { en: 'What to do',                         es: 'Qué hacer' },
  'rem.what.ph':     { en: 'e.g. Upload my pay records',         es: 'ej. Subir mis recibos de pago' },
  'rem.when':        { en: 'When (optional)',                    es: 'Cuándo (opcional)' },
  'rem.save':        { en: 'Save',                               es: 'Guardar' },
  'rem.cancel':      { en: 'Cancel',                             es: 'Cancelar' },
  'rem.loading':     { en: 'Loading your reminders…',            es: 'Cargando tus recordatorios…' },
  'rem.empty':       { en: 'Nothing yet. Add what’s next, or tap a suggestion above.',
                       es: 'Nada aún. Agrega lo que sigue o toca una sugerencia arriba.' },
  'rem.fromFirm':    { en: 'from your firm',                     es: 'de tu bufete' },
  'rem.markDone':    { en: 'Mark done',                          es: 'Marcar como hecho' },
  'rem.markUndone':  { en: 'Mark not done',                      es: 'Marcar como no hecho' },
  'rem.remove':      { en: 'Remove reminder',                    es: 'Eliminar recordatorio' },
  'rem.saving':      { en: 'Saving…',                            es: 'Guardando…' },
  'rem.disclaimer':  { en: 'These are your own reminders. one3seven never calculates a legal deadline — any date is one you or your firm set.',
                       es: 'Estos son tus propios recordatorios. one3seven nunca calcula un plazo legal — cualquier fecha la pones tú o tu bufete.' },
  'rem.suggest.pay_records':       { en: 'Upload my pay records',            es: 'Subir mis recibos de pago' },
  'rem.suggest.personnel_file':    { en: 'Request my personnel file',        es: 'Solicitar mi expediente personal' },
  'rem.suggest.expert_appointment':{ en: 'Expert examination appointment',   es: 'Cita de examen con el experto' },
  'rem.suggest.signed_forms':      { en: 'Send back signed forms',           es: 'Devolver formularios firmados' },
  'rem.suggest.timeline_gaps':     { en: 'Fill gaps in my timeline',         es: 'Llenar vacíos en mi cronología' },
  // Records-request card (worker requests copies of their own records; worker sends it)
  'rr.eyebrow':      { en: 'Request your records',               es: 'Solicita tus registros' },
  'rr.title':        { en: 'Get copies of your own records.',    es: 'Obtén copias de tus propios registros.' },
  'rr.desc':         { en: 'Pick what you want, and one3seven writes the request. You send it from your own email — and we keep a dated record that you asked.',
                       es: 'Elige lo que quieras y one3seven escribe la solicitud. Tú la envías desde tu propio correo — y guardamos un registro fechado de que la pediste.' },
  'rr.type.personnel_file':  { en: 'My personnel file',                 es: 'Mi expediente de personal' },
  'rr.type.pay_records':     { en: 'My pay records / wage statements',  es: 'Mis registros de pago / recibos de nómina' },
  'rr.type.time_records':    { en: 'My time / timekeeping records',     es: 'Mis registros de horario / asistencia' },
  'rr.type.signed_documents':{ en: 'Documents I signed',               es: 'Documentos que firmé' },
  'rr.recipient':    { en: 'Send to (employer / HR email)',      es: 'Enviar a (correo del empleador / RR. HH.)' },
  'rr.recipient.ph': { en: 'e.g. hr@company.com',                es: 'p. ej. rrhh@empresa.com' },
  'rr.yourname':     { en: 'Your name (for the signature)',      es: 'Tu nombre (para la firma)' },
  'rr.yourname.ph':  { en: 'The name your employer knows you by', es: 'El nombre con el que te conoce tu empleador' },
  'rr.compose':      { en: 'Write my request',                   es: 'Escribir mi solicitud' },
  'rr.preview':      { en: 'Your request — you send this',       es: 'Tu solicitud — esto lo envías tú' },
  'rr.openEmail':    { en: 'Open in my email',                   es: 'Abrir en mi correo' },
  'rr.copy':         { en: 'Copy',                               es: 'Copiar' },
  'rr.copied':       { en: 'Copied',                             es: 'Copiado' },
  'rr.markSent':     { en: 'I’ve sent it — log the date',        es: 'Ya la envié — registrar la fecha' },
  'rr.subject':      { en: 'Request for my employment records',  es: 'Solicitud de mis registros de empleo' },
  'rr.body.intro':   { en: 'Hello, I’m requesting copies of the following records related to my employment:',
                       es: 'Hola: Solicito copias de los siguientes registros relacionados con mi empleo:' },
  'rr.body.outro':   { en: 'Please let me know how and when I can receive these. You can reply to this email. Thank you,',
                       es: 'Por favor infórmenme cómo y cuándo puedo recibirlos. Pueden responder a este correo. Gracias,' },
  'rr.empty':        { en: 'No requests logged yet. When you ask an employer for your records, log it here so you have a dated record.',
                       es: 'Aún no hay solicitudes. Cuando pidas tus registros a un empleador, regístralo aquí para tener un registro fechado.' },
  'rr.sent':         { en: 'Sent',                               es: 'Enviada' },
  'rr.received':     { en: 'Response received',                  es: 'Respuesta recibida' },
  'rr.markReceived': { en: 'Mark response received',             es: 'Marcar respuesta recibida' },
  'rr.remove':       { en: 'Remove',                             es: 'Eliminar' },
  'rr.loading':      { en: 'Loading…',                           es: 'Cargando…' },
  'rr.disclaimer':   { en: 'You’re requesting your own records, and you send the request yourself. one3seven helps you write it and keeps your dated record — it doesn’t send it for you, and this isn’t legal advice.',
                       es: 'Estás solicitando tus propios registros, y tú mismo envías la solicitud. one3seven te ayuda a escribirla y guarda tu registro fechado — no la envía por ti, y esto no es asesoría legal.' },
  ...
  'wl.how.h2':       { en: 'Three steps. No legal mumbo jumbo.',      es: 'Tres pasos. Sin complicaciones legales.' },
  ...
  // Evidence-instrument rows in the hero card (organize-only: dated/logged/collected — never a merit claim).
  'wl.ev1':          { en: 'Complaint to HR, dated',            es: 'Queja a RR. HH., fechada' },
  'wl.ev2':          { en: 'Hours worked, logged',              es: 'Horas trabajadas, registradas' },
  'wl.ev3':          { en: 'Pay records, collected',            es: 'Registros de pago, reunidos' },
  'wl.ev.status':    { en: 'Your record · 3 files, each linked to its source', es: 'Tu expediente · 3 archivos, cada uno vinculado a su fuente' },
  'wl.hero.g1':      { en: 'Every text, stub, and email — sorted by date, each one linked back to the original, the way a lawyer reads a file.',
                       es: 'Cada mensaje, recibo y correo — ordenado por fecha, cada uno enlazado a su original, como un abogado lee un expediente.' },
