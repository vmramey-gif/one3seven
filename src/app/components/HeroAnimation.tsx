 ...
 * Pure CSS keyframes so it's crisp and dependency-free; respects prefers-reduced-motion
 * (shows the resolved packet immediately). Sits directly on the dark hero (transparent bg).
 */

const CSS = `
.ha-wrap{position:relative;width:100%;aspect-ratio:4/3;min-height:360px;overflow:hidden}
.ha-glow{position:absolute;width:78%;height:78%;left:50%;top:48%;transform:translate(-50%,-50%);background:radial-gradient(circle,rgba(124,92,255,0.22),transparent 60%);opacity:0;animation:haGlow 1.4s 2.4s ease forwards}
.ha-doc{position:absolute;width:96px;border-radius:9px;background:#FAF9F6;padding:8px 9px;opacity:0;box-shadow:0 10px 28px rgba(0,0,0,0.40)}
...
.ha-card{position:absolute;left:50%;top:48%;width:88%;max-width:312px;transform:translate(-50%,-50%) scale(0.82);opacity:0;background:#FAF9F6;border-radius:14px;padding:15px 17px;animation:haCard 1s 2.3s cubic-bezier(.34,1.56,.64,1) forwards}
...
@keyframes haF1{0%{opacity:0;transform:translate(0,0) rotate(-20deg) scale(.8)}10%{opacity:1;transform:translate(0,0) rotate(-16deg) scale(1.06)}20%{transform:translate(0,0) rotate(-16deg) scale(1)}52%{opacity:1;transform:translate(0,0) rotate(-16deg) scale(1)}100%{opacity:0;transform:translate(205px,160px) rotate(0) scale(.22)}}
@keyframes haF2{0%{opacity:0;transform:translate(0,0) rotate(15deg) scale(.8)}10%{opacity:1;transform:translate(0,0) rotate(12deg) scale(1.06)}20%{transform:translate(0,0) rotate(12deg) scale(1)}52%{opacity:1;transform:translate(0,0) rotate(12deg) scale(1)}100%{opacity:0;transform:translate(-105px,165px) rotate(0) scale(.22)}}
@keyframes haF3{0%{opacity:0;transform:translate(0,0) rotate(13deg) scale(.8)}10%{opacity:1;transform:translate(0,0) rotate(9deg) scale(1.06)}20%{transform:translate(0,0) rotate(9deg) scale(1)}52%{opacity:1;transform:translate(0,0) rotate(9deg) scale(1)}100%{opacity:0;transform:translate(210px,-55px) rotate(0) scale(.22)}}
@keyframes haF4{0%{opacity:0;transform:translate(0,0) rotate(-12deg) scale(.8)}10%{opacity:1;transform:translate(0,0) rotate(-9deg) scale(1.06)}20%{transform:translate(0,0) rotate(-9deg) scale(1)}52%{opacity:1;transform:translate(0,0) rotate(-9deg) scale(1)}100%{opacity:0;transform:translate(-110px,-65px) rotate(0) scale(.22)}}
@keyframes haF5{0%{opacity:0;transform:translate(0,0) rotate(-7deg) scale(.8)}10%{opacity:1;transform:translate(0,0) rotate(-5deg) scale(1.06)}20%{transform:translate(0,0) rotate(-5deg) scale(1)}52%{opacity:1;transform:translate(0,0) rotate(-5deg) scale(1)}100%{opacity:0;transform:translate(50px,170px) rotate(0) scale(.22)}}
@keyframes haF6{0%{opacity:0;transform:translate(0,0) rotate(9deg) scale(.8)}10%{opacity:1;transform:translate(0,0) rotate(6deg) scale(1.06)}20%{transform:translate(0,0) rotate(6deg) scale(1)}52%{opacity:1;transform:translate(0,0) rotate(6deg) scale(1)}100%{opacity:0;transform:translate(40px,-95px) rotate(0) scale(.22)}}
...
export function HeroAnimation() {
  return (
    <div className="ha-wrap" role="img" aria-label="Scattered employment records — texts, a pay stub, an HR complaint, an email, a schedule, and a written warning — converge into an organized, source-linked intake timeline.">
      ...
      <div className="ha-doc ha-f2" style={{ left: '74%', top: '5%' }}>
      ...
      <div className="ha-doc ha-f3" style={{ left: '3%', top: '66%' }}>
      ...
      <div className="ha-doc ha-f4" style={{ left: '75%', top: '68%' }}>
      ...
      <div className="ha-doc ha-f5" style={{ left: '39%', top: '2%' }}>
      ...
      <div className="ha-doc ha-f6" style={{ left: '41%', top: '75%' }}>
