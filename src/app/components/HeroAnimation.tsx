...
.hp-tag{font:700 11px/1 -apple-system,BlinkMacSystemFont,sans-serif;letter-spacing:0.14em;color:#5B21B6}
...
.hp-cats{margin:10px 0 4px;font:600 10px/1.5 -apple-system,sans-serif;color:#5B21B6}
...
.hp-node{position:absolute;left:-20px;top:3px;width:12px;height:12px;border-radius:50%;background:#6D4AFF;box-shadow:0 0 0 4px #FAF9F6}
...
.hp-src{display:inline-flex;gap:5px;margin-top:5px;font:600 10px/1 -apple-system,sans-serif;color:#5B21B6;background:rgba(109,74,255,0.10);border-radius:6px;padding:4px 8px}
