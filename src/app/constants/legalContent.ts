  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text: 'Account-level deletion (removing your account entirely) is not available through self-service during the current beta period. To request account deletion, contact one3seven at legal@one3seven.com. We will delete your account and associated data within 45 days of a verified request, as required by California law.' },
