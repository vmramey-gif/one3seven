...
export const TERMS_OF_SERVICE: LegalDoc = {
  ...
  effective: 'Effective June 23, 2026',
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        { type: 'p', text: 'one3seven is provided “as is” and “as available.” One3Seven Ventures LLC makes no warranty, express or implied, that the platform will be error-free, uninterrupted, or that the organized summaries will be complete or accurate in every case.' },
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text: 'No security system is perfect. While we take reasonable technical measures to protect your data, we cannot guarantee that unauthorized access, disclosure, or loss will never occur.' },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text: 'If you are a California resident, you have rights under the California Consumer Privacy Act (CCPA), including the right to know what personal information we collect, the right to delete your personal information, and the right not to be discriminated against for exercising these rights. To exercise these rights, contact us at legal@one3seven.com.' },
      ],
    },
    {
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'p', text: 'Each of these services has its own privacy practices. We have selected services that operate under commercial terms that limit the use of data processed on our behalf.' },
      ],
    },
    {
