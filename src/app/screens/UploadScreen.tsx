    ...
    <div className={UPLOAD_PAGE_SHELL}>
      ...
      <div className={`px-5 sm:px-6 ${shellMode ? 'pt-3' : 'pt-4'}`}>
        <button
          ...
          className="flex items-center gap-1.5 text-[11px] uppercase tracking-wide text-slate-500 hover:text-violet-700 transition-colors duration-200 font-normal"
        >
      ...
      <div className={`px-5 sm:px-6 ${shellMode ? 'pt-3' : 'pt-4'} pb-10 max-w-3xl`}>
        ...
        >
          {docRequestFocusMode ? (
            <div className="mb-3">
              <h1 className="text-xl font-semibold text-[#15112f] tracking-tight">
            ...
            <div className="mb-4">
              ...
              <p className="text-sm text-slate-600 mt-1 leading-relaxed">{STORY_FIRST_UPLOAD_INTRO}</p>
              ...
              >
                ...
                <ul className="space-y-1.5">
                  {pendingUploadFiles.map((file) => (
                    <li key={`pending-${file.name}-${file.size}-${file.lastModified}`} className="text-xs text-slate-700 truncate">
                      {file.name}
                    </li>
                  ))}
                </ul>
              ...
              <div className="space-y-2">
                ...
                {uploadedFiles.length > 3 && (
                  <motion.button
                    ...
                    className="w-full text-sm text-slate-600 hover:text-violet-700 py-2 rounded-lg hover:bg-violet-50 transition-colors"
                  >
                    {showAllFiles ? (
                      'Show Less ∧'
                    ) : (
            ...
            <div className="mb-4 border-b border-violet-100 pb-3">
              {showStoryPreview ? (
                ...
                <div className="flex items-center justify-between gap-3">
                  <p className="text-sm text-slate-600">{WORKER_UPLOAD_COPY.storyProvided}</p>
                  <button
                    type="button"
              ...
              <div className="mt-3 space-y-2.5">
                ...
                <div className="rounded-[14px] border border-violet-100 bg-white px-4 py-3.5 shadow-sm">
                  ...
                  <input
                    ...
                    className="mt-2.5 w-full rounded-[10px] border border-violet-200 bg-white px-3 py-2.5 text-sm text-[#15112f] placeholder:text-slate-400 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-100"
                ...
                <div className="rounded-[14px] border border-violet-100 bg-white px-4 py-3.5 shadow-sm">
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="mt-2.5 w-full rounded-[10px] border border-violet-200 bg-white px-3 py-2.5 text-sm text-[#15112f] placeholder:text-slate-400 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-100 resize-none"
                ...
                {isEmploymentIntake ? (
                  <>
                    ...
                    <div className="rounded-[14px] border border-violet-100 bg-white px-4 py-3.5 shadow-sm">
                      ...
                      <p className="text-xs text-slate-500 mb-2.5 leading-relaxed">This may have been part of your offer letter or onboarding paperwork.</p>
                      <div className="flex flex-wrap gap-2">
                    ...
                    <div className="rounded-[14px] border border-violet-100 bg-white px-4 py-3.5 shadow-sm">
                      ...
                      <p className="text-xs text-slate-500 mb-2.5 leading-relaxed">For example: EEOC, California Civil Rights Department (CRD / former DFEH), DLSE, or the Labor Commissioner.</p>
                      ...
                      {followUp.priorAgencyFiling === 'yes' ? (
                        <input
                          ...
                          className="mt-1 w-full rounded-[10px] border border-violet-200 bg-white px-3 py-2.5 text-sm text-[#15112f] placeholder:text-slate-400 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-100"
            ...
            <div className="mb-8 rounded-[14px] border border-violet-100 bg-white p-4 shadow-sm">
              ...
              <div className="flex flex-col gap-2 sm:flex-row">
                <input
                  ...
                  className="flex-1 px-4 py-3 rounded-[14px] border border-violet-200 bg-white text-sm text-[#15112f] placeholder:text-slate-500 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-100"
                />
                <button
                  type="button"
          ...
          {docRequestFocusMode && onOpenIntakeSummary ? (
            <details className="mb-4 border-b border-violet-100 group">
              <summary className="cursor-pointer list-none py-2.5 text-sm font-medium text-slate-600 marker:content-none flex items-center justify-between gap-2">
                ...
                <>
                  ...
                  <div className="space-y-2 mb-4">
                    <input
                      ...
                      placeholder="Enter Firm Code"
                      className="w-full px-4 py-3 rounded-[14px] border border-violet-200 bg-violet-50/50 text-sm text-[#15112f] placeholder:text-slate-500 focus:border-violet-500 focus:outline-none focus:ring-2 focus:ring-violet-100"
                      disabled={firmGateBusy}
                    />
                    <button
                      type="button"
